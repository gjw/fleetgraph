...
const createDocumentSchema = z.object({
  ...
  document_type: z.enum(['wiki', 'issue', 'program', 'project', 'sprint', 'person', 'weekly_plan', 'weekly_retro', 'fleetgraph_finding']).optional().default('wiki'),
...
const updateDocumentSchema = z.object({
  ...
  properties: z.record(z.unknown()).optional(),
  visibility: z.enum(['private', 'workspace']).optional(),
  document_type: z.enum(['wiki', 'issue', 'program', 'project', 'sprint', 'person', 'fleetgraph_finding']).optional(),
